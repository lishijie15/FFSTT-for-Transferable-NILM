...
def transfer_fine(appliance_name, model, mains, appliance, epochs, batch_size, train_patience = 3):
    ...
    if USE_CUDA:
        ...
        pretrained_dict = torch.load(os.path.join("./" + appliance_name + "_seq2point_best_state_dict_uk.pt"))
    ...
    for epoch in range(epochs):
        ...
        if best_loss is None or final_loss < best_loss:
            best_loss = final_loss
            patience = 0
            best_model_path = "./{}_seq2point_best_state_dict.pt".format(appliance_name)
